...
const postFilters = [
  ...
  <TextInput
    key={"comment"}
    label="comment"
    source="where.comment.like"
    alwaysOn={true}
  />,
];

export const ListRating = (props: any) => {
...
export const ShowRating = (props: any) => {
  return (
    <Show>
      <TabbedShowLayout>
              ...
              <FunctionField
                ...
                render={(record: any) => {
                  ...
                  if (image.length > 0) {
                    ...
                    return (
                      <img src={image.url} className="w-28 h-28 rounded-lg" />
                    );
                  }
                }}
              />
              ...
              <div>
                ...
                <div className="px-4 py-2 my-2 border-2 border-gray-300 rounded-lg">
                  <FunctionField
                    ...
                    render={(record: any) => {
                      return (
                        <div>{`${record.fromProvince.split(`-`)[0]}`} </div>
                      );
                    }}
                  />
                </div>
              ...
              <div>
                ...
                <div className="px-4 py-2 my-2 border-2 border-gray-300 rounded-lg">
                  <FunctionField
                    ...
                    render={(record: any) => {
                      return (
                        <div>{`${record.fromDistrict.split(`-`)[0]}`} </div>
                      );
                    }}
                  />
                </div>
